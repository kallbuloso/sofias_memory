...
class ErrorCode(StrEnum):
    ...
    RESERVED_IDEMPOTENCY_KEY_NAMESPACE = "RESERVED_IDEMPOTENCY_KEY_NAMESPACE"
    WORKER_DISABLED = "WORKER_DISABLED"
    RUN_NOT_RETRYABLE = "RUN_NOT_RETRYABLE"
    MAIN_DATASET_DELETE_FORBIDDEN = "MAIN_DATASET_DELETE_FORBIDDEN"
    DATASET_DELETING = "DATASET_DELETING"
